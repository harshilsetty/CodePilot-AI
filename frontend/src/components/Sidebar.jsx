  ...
  return (
    <aside className="fixed left-0 top-0 h-full flex flex-col p-4 pb-5 space-y-4 bg-bg-secondary text-text-primary text-sm font-medium w-64 border-r border-text-secondary/10 shadow-soft z-20">
      ...
      <div className="flex items-center space-x-3 px-1 mt-1 shrink-0">
        <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0 overflow-hidden bg-transparent">
          <img src={Logo} alt="PrepPilot AI Logo" className="w-full h-full object-contain scale-[1.15]" />
        </div>
        <div>
          <h2 className="text-text-primary font-['Space_Grotesk'] font-bold text-base leading-none tracking-wide">PrepPilot <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-accent-cyan">AI</span></h2>
          <p className="text-text-secondary text-[9px] mt-1 pr-1 font-medium tracking-wide">Practice Smarter. Perform Better.</p>
        </div>
      </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar flex flex-col space-y-6 pr-2 -mr-2">
        {/* Main Navigation Section */}
        <nav className="space-y-1 shrink-0 mt-2">
        ...
        <div className="flex flex-col shrink-0 border-t border-text-secondary/10 pt-4">
      ...
      <div className="pt-4 border-t border-text-secondary/10 shrink-0 mt-auto">
        <div className="px-3 py-3 mb-3 rounded-lg glass-effect-sm border border-text-secondary/10 hover:border-text-secondary/20 transition-colors duration-200">
          ...
          <div style={{ perspective: '800px' }} className="mt-2 mb-1 truncate">
            <p className="text-sm font-semibold name-3d-animated" style={{ animationDuration: '4s' }}>
